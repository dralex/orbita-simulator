...
#include <memory>
#include "../orbita-app/imagesmodel.h"
...
QT_MOC_LITERAL(2, 17, 21) // "SimulationController*"

    },
    "ImagesModel\0list\0SimulationController*"
};
...
void ImagesModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        case 0:
            *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< SimulationController* >(); break;
        }
    }

#ifndef QT_NO_PROPERTIES
    else if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<ImagesModel *>(_o);
        (void)_t;
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< SimulationController**>(_v) = _t->list(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setList(*reinterpret_cast< SimulationController**>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ImagesModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractListModel::staticMetaObject>(),
    qt_meta_stringdata_ImagesModel.data,
    qt_meta_data_ImagesModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
